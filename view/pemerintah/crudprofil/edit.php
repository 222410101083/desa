<div class="bg-white overflow-hidden shadow rounded-lg border">
    <div class="px-4 py-5 sm:px-6">
        <h3 class="text-lg leading-6 font-medium text-gray-900">
            Ubah Profil Pemerintah
        </h3>
    </div>
    <form action="<?= BASEURL . 'pemerintah/profil/edit?id=' . $user['id']; ?>" method="POST"
        enctype="multipart/form-data">
        <div class="flex justify-center">
            <div class="sm:col-span-1 flex sm:justify-center mt-2 mb-2 h-24 w-24 rounded-full">
                <img class=" object-cover h-24 w-24 rounded-full" src="<?= BASEURL.$user['avatar'] ?>" alt="Foto Profil">
            </div>
        </div>
