...
<div class="w-full flex flex-col justify-center items-center">
    ...
    <div class="justify-center w-3/4">
        <button class="bg-blue-500 text-white px-4 py-2 rounded-md mb-5" id="downloadPDF">Print</button>
    ...
    <div class="justify-center w-3/4 mt-2">
        <button class="bg-blue-500 text-white px-4 py-2 rounded-md mb-5" id="printAduanChart">Print</button>
        <div class="flex justify-center items-center">
            <canvas id="aduanChart"></canvas>
            <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
            <script>
                var colors = ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(153, 102, 255, 0.2)', 'rgba(255, 159, 64, 0.2)', 'rgba(255, 99, 100, 0.2)', 'rgba(54, 100, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(153, 102, 255, 0.2)', 'rgba(255, 159, 64, 0.2)'];
