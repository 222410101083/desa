<div class="container mt-10 mx-10 min-h-max min-w-full">
    ...
    <a href="tambahakun" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Tambah Akun
        Pemerintah</a>
                            ...
                            <div id="modal-password-<?= $user['id'] ?>" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="relative p-4 w-full max-w-md h-auto">
                                    ...
                                    <div class="relative bg-gray-700 rounded-lg shadow">
                                        ...
                                        <!-- Modal Content -->
                                        <form class="max-w-sm mx-auto" action="<?= BASEURL ?>admin/pemerintah"
                                            method="post">
